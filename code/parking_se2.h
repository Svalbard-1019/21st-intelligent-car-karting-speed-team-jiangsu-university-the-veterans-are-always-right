...
/* A parking entry is an axis, so headings separated by 180 degrees describe
 * the same entry line. Return the smallest rotation between those axes. */
...
/* Transform one taught point from the recorded parking-entry frame into the
