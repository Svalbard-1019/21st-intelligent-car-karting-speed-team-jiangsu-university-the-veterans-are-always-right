...
void Menu_Mode_Choice(void)
{
    ...
    if(key_value == 3)
    {
        ...
        else if (key_mode1 ==4){main_mode = Guandao_portion_1 ;  route_setting_choice = 0; conrtol_mode = GUANDAO ; daoche_speed = (float)control[1]; portion_1_reset(); Buzzer_check(50);}
