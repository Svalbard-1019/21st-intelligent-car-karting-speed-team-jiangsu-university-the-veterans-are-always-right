...
static void Serial_Debug_Update(void)
{
    ...
    else if(main_mode == Guandao_portion_1)
    {
        len = snprintf(line,
                      sizeof(line),
                      "AUTO,t=%lu,idx=%d,len=%d,D100=%ld,A10=%ld,DF100=%ld,reason=%d,x100=%ld,y100=%ld,yaw10=%ld,off10=%ld,base10=%ld,vc10=%ld,avg10=%ld,vl10=%ld,vr10=%ld,servo10=%ld,tgt100=%ld,act100=%ld,pwm=%d,enc10=%d,enc100=%ld\r\n",
                      (unsigned long)now_ms,
